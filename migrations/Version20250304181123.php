...
final class Version20250304181123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE `service` SET `client_send_notify`=(SELECT `client_point`.`send_notify` FROM `client_point` WHERE `client_point`.`id`=`service`.`client_point_id` ) WHERE `service`.`id`>0;');
